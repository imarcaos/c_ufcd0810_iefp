...
/*
Exerc�cio 7
Crie uma classe em C++ por forma a registar os movimentos de uma conta banc�ria. Vamos
considerar os seguintes atributos:
string data, string descricao, char tipo_movimento (D ou L), float valor.
Crie um vetor din�mico para armazenar os movimentos
?Considere os seguintes m�todos:
- Registar movimento.
- Listagem de movimentos.
- Consulta de saldo.
Crie um loop na fun��o main (menu) para solicitar ao utilizador a sua escolha.
*/
...
int main(){
    ...
    do{
        system("cls");
        cout<<"Registo de movimento banc�rio"<<endl;
        ...
        switch (opcao){
            ...
            case 1:
                ...
                cout<<"Tipo de movimento (D-dep�sito L-levantamento): ";
            ...
            case 3:
                ...
                break;
            default:
                cout<<"Op��o inv�lida. Enter para continuar..";
                getch();
        }      
